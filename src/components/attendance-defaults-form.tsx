    ...
    <form onSubmit={onSubmit} className="space-y-6 rounded-xl border bg-white p-4 shadow-sm">
      <section className="space-y-3">
        ...
        <p className="text-sm text-slate-600">
          裁量労働制では、所定労働日の実勤務にみなし労働9:30・みなし法定外1:30を付与し、土曜・祝日は所定休日実労働、日曜は法定休日として集計します（実労働の9:30超は参考値のみ）。勤務表では月ごとに通常／裁量を選べます（2026年6月以前は通常、2026年7月は裁量が初期値）。保存した内容は以降の入力・再保存から適用されます。
        </p>
